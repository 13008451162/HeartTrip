...
public class Carousel {
     ...
     */
    public void initViews(ArrayList<String> resource) {
        ...
        for (String id : resource) {
            ...
            //设置标志点的布局参数
            LinearLayout.LayoutParams dotImageLayoutParams = new LinearLayout.LayoutParams(30, 30);
